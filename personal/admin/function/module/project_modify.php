...
?>
<div class='box'>
<div class='box-header'><h1>Edit project | <a href="<?php echo $link_dong; ?>" style='color: white'>Close</a></h1></div>
	<form action="" method="post" enctype="multipart/form-data">
		<table width="976px" border="0" style="clear:left;margin:5px">
			...
			<tr>
				<td>&nbsp;</td>
				<td>
					<input type="hidden" name="function" value="project_modify_action">
