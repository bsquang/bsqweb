...
?>
<div class='box'>
<div class='box-header'><h1>Add showcase item | <a href="<?php echo $link_dong; ?>" style='color: white'>Close</a></h1></div>
	<form action="" method="post" enctype="multipart/form-data">
		<table width="976px" border="0" style="margin:5px" >			
			...
			<tr>
				...
				<td>
					<input type="hidden" name="function" value="showcase_add_action">
