...
<div class='box'>
    <div class='box-header'><h1>Project | <a style='color: white;' href="?thamso=project_add">Add</a></h1></div>
    ...
    <table border="0" style='margin: 5px;width: 900px;'>
            ...
            <?php 
                    while($tv_2=mysql_fetch_array($tv_1))
                    {
                            ...
                            $link_sua="?thamso=project_modify&id=".$tv_2['id'];
                            $link_xoa="?thamso=project_remove_action&id=".$tv_2['id'];
